            ...
            <div className="bg-white/50 p-3 rounded-lg">
              ...
              <div className="space-y-1 text-[#8A5691]">
                <div className="flex">
                  ...
                  <p className="truncate">{request.email || "No Email Found"}</p>
                </div>
                <div className="flex">
            ...
            <div className="bg-white/50 p-3 rounded-lg">
              ...
              <div className="space-y-1 text-[#8A5691]">
                ...
                <div className="flex">
                  ...
                  <p>{new Date(request.expected_adoption_date).toLocaleDateString()}</p>
                </div>
                <div className="flex">
                  <p className="font-semibold w-24">Actual:</p>
                  <p>{request.actual_adoption_date ? new Date(request.actual_adoption_date).toLocaleDateString() : "N/A"}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/50 p-3 rounded-lg">
              ...
              <div className="space-y-2 text-[#8A5691]">
                <div>
                  <p className="font-semibold w-24">Temperament:</p>
                  <p>{request.pet.temperament}</p>
                </div>
                <div>
